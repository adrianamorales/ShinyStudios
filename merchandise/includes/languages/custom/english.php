...
// whats_new box text in sideboxes/whats_new.php
  define('BOX_HEADING_WHATS_NEW', 'New Merchandise');
  define('CATEGORIES_BOX_HEADING_WHATS_NEW', 'New Merchandise ...');

  define('BOX_HEADING_FEATURED_PRODUCTS', 'Featured');
  define('CATEGORIES_BOX_HEADING_FEATURED_PRODUCTS', 'Featured Merchandise ...');
  define('TEXT_NO_FEATURED_PRODUCTS', 'More featured merchandise will be added soon. Please check back later.');

  define('TEXT_NO_ALL_PRODUCTS', 'More merchandise will be added soon. Please check back later.');
  define('CATEGORIES_BOX_HEADING_PRODUCTS_ALL', 'All Merchandise ...');
...
// javascript messages
  ...
  define('PREVNEXT_TITLE_PREVIOUS_PAGE', 'Previous');
  define('PREVNEXT_TITLE_NEXT_PAGE', 'Next');
  ...
  define('TEXT_NO_REVIEWS', 'There are currently no reviews.');

  define('TEXT_NO_NEW_PRODUCTS', 'More merchandise will be added soon. Please check back later.');
...
// for all pages except where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCT', 'Successfully added to the cart ...');
// only for where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCTS', 'Successfully added to the cart ...');
