...
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Add to Cart');
...
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Return to Merchandise List');
define('BUTTON_REVIEWS_ALT', 'Go to the Reviews');
...
define('BUTTON_READ_REVIEWS_ALT', 'Read Review');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Merchandise Information');
